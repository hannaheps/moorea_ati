###R Script for Alpha Diversity Regressions: Around-the-Island Water Microbe Samples (16S)###

##Let's look at some regressions!##
...
#set your working directory (should be in /core_analysis/alpha_div/procedure)
...
p1 <- ggplot(erich, aes(x = log(Silicate), y = Microbial_Species_Richness)) +
  geom_point(size=2) +
...
p2 <- ggplot(erich, aes(x = log(Silicate), y = Microbial_Shannon_Diversity)) +
  geom_point(size=2) +
  geom_smooth(method=lm) +
  xlab("Log10(Silicate)") +
...
p3 <- ggplot(erich, aes(x = log(Silicate), y = Microbial_Phylogenetic_Diversity)) +
  geom_point(size=2) +
  geom_smooth(method=lm) +
  xlab("log10(Silicate)") +
...
p4 <- ggplot(erich, aes(x = log(Silicate), y = Microbial_Evenness)) +
  geom_point(size=2) +
  geom_smooth(method=lm) +
  xlab("log10(Silicate)") +
...
ggsave("../output/plots/microbial_alpha_div_vs_silicate.pdf", plot = last_plot())


#Trial the same as above but with the %N

p5 <- ggplot(erich, aes(x = Percent_N, y = Microbial_Species_Richness)) +
  geom_point(size=2) +
  geom_smooth(method=lm) +
  xlab("Turbinaria %N") +
  ylab("Microbial Species Richness") +
...
p6 <- ggplot(erich, aes(x = Percent_N, y = Microbial_Shannon_Diversity)) +
  geom_point(size=2) +
  geom_smooth(method=lm) +
  xlab("Turbinaria %N") +
  ylab("Microbial Shannon Diversity") +
...
p7 <- ggplot(erich, aes(x = Percent_N, y = Microbial_Phylogenetic_Diversity)) +
  geom_point(size=2) +
  geom_smooth(method=lm) +
  xlab("Turbinaria %N") +
  ylab("Microbial Phylogenetic Diversity") +
...
p8 <- ggplot(erich, aes(x = Percent_N, y = Microbial_Evenness)) +
  geom_point(size=2) +
  geom_smooth(method=lm) +
  xlab("Turbinaria %N") +
  ylab("Microbial Evenness") +
...
ggsave("../output/plots/microbial_alpha_div_percN.pdf", plot = last_plot())

#Observed vs. water Nutrients
p9 <- ggplot(erich, aes(x = log(Silicate), y = Microbial_Species_Richness)) +
  geom_point(size=2) +
  geom_smooth(method=lm) +
  xlab("log10(Silicate)") +
  ylab("Microbial Species Richness") +
...
p10 <- ggplot(erich, aes(x = Phosphate, y = Microbial_Species_Richness)) +
  geom_point(size=2) +
  geom_smooth(method=lm) +
  xlab("Phosphate") +
  ylab("Microbial Species Richness") +
...
p11 <- ggplot(erich, aes(x = Ammonia, y = Microbial_Species_Richness)) +
  geom_point(size=2) +
  geom_smooth(method=lm) +
  xlab("Ammonia") +
  ylab("Microbial Species Richness") +
...
p12 <- ggplot(erich, aes(x = Nitrite_plus_Nitrate, y = Microbial_Species_Richness)) +
  geom_point(size=2) +
  geom_smooth(method=lm) +
...
ggsave("../output/plots/microbial_richness_water_nutrients.pdf", plot = last_plot())

##Relationship with nitrite vs nitrate so check all microbial metrics
p13 <- ggplot(erich, aes(x = Nitrite_plus_Nitrate, y = Microbial_Species_Richness)) +
  geom_point(size=2) +
  geom_smooth(method=lm) +
  xlab("Nitrite plus Nitrate") +
  ylab("Microbial Species Richness") +
...
p14 <- ggplot(erich, aes(x = Nitrite_plus_Nitrate, y = Microbial_Shannon_Diversity)) +
  geom_point(size=2) +
  geom_smooth(method=lm) +
  xlab("Nitrite plus Nitrate") +
  ylab("Microbial Shannon Diversity") +
...
p15 <- ggplot(erich, aes(x = Nitrite_plus_Nitrate, y = Microbial_Phylogenetic_Diversity)) +
  geom_point(size=2) +
  geom_smooth(method=lm) +
  xlab("Nitrite plus Nitrate") +
  ylab("Microbial Phylogenetic Diversity") +
...
p16 <- ggplot(erich, aes(x = Nitrite_plus_Nitrate, y = Microbial_Evenness)) +
  geom_point(size=2) +
  geom_smooth(method=lm) +
  xlab("Nitrite plus Nitrate") +
  ylab("Microbial Evenness") +
...
ggsave("../output/plots/microbial_alpha_div_nitrite_nitrate.pdf", plot = last_plot())
